...
<div class="banner">
	<div class="col-md-2 banner-left">
		  <h1><a href="index.php"> <img src="images/logoplantilla.png" alt="logo" id="logo"/>  
                        ...
                        <p>“La música es una cosa amplia, sin límites, sin fronteras, sin banderas”. León Gieco.</p>
			...
			<div class="nav-left">
				<span class="menu"><img src="images/menu.png" alt=""/></span>
						<ul class="nav1">
							...
							<li class="hvr-underline-from-left button2"><a class="active" href="shortcodes.php">Ubicacion</a></li>
