                ...
                <div class="navigation">
                    <div class="nav-left">
                        ...
                        <ul class="nav1">
                            ...
                            <li class="hvr-underline-from-left button2"><a class="active" href="about.php">Sobre Puntoque</a></li>
                            ...
                            <li class="hvr-underline-from-left button2"><a href="contact.php">Iniciar Sesión</a></li>
                        </ul>
                        <!-- script for menu -->
                        <script>
